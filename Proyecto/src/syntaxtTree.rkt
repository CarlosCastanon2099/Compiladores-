...
(define (syntax-tree prog)
    (match prog
        ...
        [(usoprocedimiento nombre parametros) (string-append "(usop " (syntax-tree nombre) " (" (syntax-tree parametros) "))")]
        ...
        [(asignacionmultiple nombres valor) (string-append (string-join (map (lambda (x) (string-append "(= " (syntax-tree x) " " (syntax-tree valor) ")")) nombres) " "))]
        ...
        [(funcion nombre parametros lineas) (string-append "(funcion " (syntax-tree nombre) " [" (syntax-tree parametros) "] {" (syntax-tree lineas) "})")]
